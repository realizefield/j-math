...
<main class="g-container">
  ...
  <!-- ① ルール -->
  <div class="section-title">整数は「分子」にだけかけよう！</div>

  <div class="problem-card" style="padding:20px; margin-bottom:16px;">
    <p style="font-size:.95em; line-height:1.9; margin-bottom:0;">
      分数のたし算では分母は変えませんでしたね。かけ算も同じです！<br>
      <strong>整数をかけるときは、分子にだけかける</strong>のがルールです。分母はそのまま！
    </p>
  </div>

  <!-- ② 計算ルール図解 -->
  <div class="section-title">計算のルール</div>

  <div class="problem-card" style="padding:24px 20px; margin-bottom:16px;">
    <div style="font-size:.9em; font-weight:700; color:var(--success); margin-bottom:16px;">
      📌 整数 × 分数 ＝ <strong>（整数 × 分子）÷ 分母</strong>　（分母はそのまま！）
    </div>

    <!-- 計算の流れ -->
    <div style="display:flex; align-items:center; justify-content:center; gap:clamp(10px,2vw,20px); flex-wrap:wrap; font-size:clamp(1em,2.5vw,1.3em);">

      <!-- 左辺 -->
      <div style="text-align:center;">
        <div style="font-size:.75em; color:var(--text-sub); font-weight:700; margin-bottom:4px;">問題</div>
      ...
      <span style="font-size:1.3em; color:var(--text-sub); font-weight:700;">＝</span>

      <!-- 途中式 -->
      <div style="text-align:center;">
        <div style="font-size:.75em; color:var(--text-sub); font-weight:700; margin-bottom:4px;">分子にかける</div>
        <span class="frac">
          <span class="f-num" style="color:var(--text-sub); font-size:.85em;">
            <span style="color:var(--primary);">2</span> × <span style="color:var(--accent);">1</span>
          </span>
          <span class="f-bar"></span>
          <span class="f-den" style="color:var(--primary);">3</span>
        </span>
      </div>
      ...
      <!-- 答え -->
      <div style="text-align:center;">
        <div style="font-size:.75em; color:var(--success); font-weight:700; margin-bottom:4px;">答え</div>
        <span class="frac">
          <span class="f-num" style="color:var(--accent); font-weight:700;">2</span>
    ...
    <div class="memo-box" style="margin-top:16px; margin-bottom:0;">
      <span style="color:var(--primary); font-weight:700;">2</span> × <span style="color:var(--accent); font-weight:700;">1</span> ＝ <strong style="color:var(--accent);">2</strong>　→　分子は <strong style="color:var(--accent);">2</strong>、分母はそのまま <strong style="color:var(--primary);">3</strong>
    </div>
  </div>

  <!-- ③ なぜ分母はそのまま？ -->
  <div class="section-title">なぜ分母はそのままなの？</div>

  <div class="problem-card" style="padding:20px; margin-bottom:20px;">
    <p style="font-size:.95em; line-height:1.9; margin-bottom:14px;">
      <span class="frac-sm" style="vertical-align:middle; margin:0 4px;">
        <span class="f-num">1</span><span class="f-bar"></span><span class="f-den">3</span>
      </span>
      が <strong>2つ分</strong> と考えると…
    </p>

    <!-- ビジュアル図：1/3 が2つ -->
    <div style="display:flex; gap:10px; align-items:flex-end; justify-content:center; margin-bottom:16px; flex-wrap:wrap;">
      <!-- 棒グラフ風 × 2本 -->
      <div style="text-align:center;">
        <div style="display:flex; gap:3px; align-items:flex-end;">
          <!-- 3等分の棒1本目（1マス塗） -->
          <div style="display:flex; flex-direction:column; gap:2px;">
            <div style="width:36px; height:28px; background:var(--accent); border-radius:4px; opacity:.8;"></div>
            <div style="width:36px; height:28px; background:var(--primary-light); border:1.5px solid var(--border); border-radius:4px;"></div>
            <div style="width:36px; height:28px; background:var(--primary-light); border:1.5px solid var(--border); border-radius:4px;"></div>
          </div>
          <span style="font-size:.8em; color:var(--text-sub); margin-left:4px;">
            <span class="frac-sm" style="vertical-align:middle;">
              <span class="f-num" style="color:var(--accent);">1</span><span class="f-bar"></span><span class="f-den">3</span>
            </span>
          </span>
        </div>
      </div>

      <span style="font-size:1.4em; font-weight:700; color:var(--text-sub);">＋</span>
      ...
      <span style="font-size:1.4em; font-weight:700;">＝</span>

      <div style="text-align:center;">
        <div style="display:flex; gap:3px; align-items:flex-end;">
          <div style="display:flex; flex-direction:column; gap:2px;">
            <div style="width:36px; height:28px; background:var(--accent); border-radius:4px;"></div>
            <div style="width:36px; height:28px; background:var(--accent); border-radius:4px; opacity:.7;"></div>
            <div style="width:36px; height:28px; background:var(--primary-light); border:1.5px solid var(--border); border-radius:4px;"></div>
          </div>
          <span style="font-size:.8em; color:var(--text-sub); margin-left:4px;">
            <span class="frac-sm" style="vertical-align:middle;">
              <span class="f-num" style="color:var(--accent); font-weight:700;">2</span><span class="f-bar"></span><span class="f-den">3</span>
            </span>
          </span>
        </div>
      </div>
    ...
    <div style="background:var(--primary-light); border-radius:10px; padding:12px 16px;">
      <p style="font-size:.9em; line-height:1.8; margin:0;">
        「3等分したうちの1個」が2つあるので、<strong>「3等分のまま」2個分</strong>になります。<br>
        → 分母（3等分）はそのまま、分子だけ 1 → <strong style="color:var(--accent);">2</strong> に増える！
      </p>
      <p style="font-size:.88em; color:var(--text-sub); margin-top:8px; margin-bottom:0;">
        ⚠️ 分母にも2をかけると
        <span class="frac-sm" style="vertical-align:middle; margin:0 3px;">
          <span class="f-num">2</span><span class="f-bar"></span><span class="f-den">6</span>
        </span>
        になり、
        <span class="frac-sm" style="vertical-align:middle; margin:0 3px;">
          <span class="f-num">1</span><span class="f-bar"></span><span class="f-den">3</span>
        </span>
        と同じ大きさのまま…これでは2倍になっていませんね。
      </p>
    </div>
  </div>

  <!-- ④ 順序が逆でもOK -->
  <div class="section-title">分数が先でも同じ！</div>
  <div class="problem-card" style="padding:20px; margin-bottom:20px;">
    <p style="font-size:.9em; line-height:1.8; margin-bottom:12px;">
      かけ算は順序を入れ替えてもOKです。分数が先に来ても同じように計算します。
    </p>
    <div style="display:flex; align-items:center; justify-content:center; gap:clamp(8px,2vw,14px); flex-wrap:wrap; font-size:clamp(1em,2.5vw,1.2em);">
      <span class="frac"><span class="f-num">3</span><span class="f-bar"></span><span class="f-den">11</span></span>
      <span class="eq-sign">×</span>
      <span style="font-weight:700; color:var(--primary);">2</span>
      <span class="eq-sign">＝</span>
      <span class="frac">
        <span class="f-num" style="color:var(--text-sub); font-size:.85em;"><span style="color:var(--accent);">3</span> × <span style="color:var(--primary);">2</span></span>
        <span class="f-bar"></span>
        <span class="f-den" style="color:var(--primary);">11</span>
      </span>
      <span class="eq-sign">＝</span>
      <span class="frac">
    ...
    <div class="memo-box" style="margin-top:12px; margin-bottom:0;">
      どちらが先でも「分子 × 整数」、分母はそのまま！
    </div>
  </div>
  ...
  <div class="summary-box">
    ...
    <ul>
      <li>整数 × 分数 ＝ <strong>（整数 × 分子）/ 分母</strong></li>
      <li>分母は <strong>絶対に変えない！</strong></li>
      <li>分数 × 整数 でも同じルール。順番はどちらでもOK。</li>
    </ul>
  </div>

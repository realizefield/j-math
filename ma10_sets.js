...
<style>
  ...
  .frac-dual .f-input {
    width:clamp(48px,10vw,68px); height:clamp(40px,8vw,52px);
    text-align:center; font-size:clamp(.9em,2.5vw,1.25em); font-weight:700;
    font-family:'BIZ UDPGothic','BIZ UDP Gothic',sans-serif;
    border:2.5px solid var(--primary); border-radius:8px;
    background:#f0f6ff; color:var(--primary); outline:none;
...
<main class="g-container">
  ...
  <div class="instruction">
    <strong>【例題】</strong>　分数どうしのかけ算を練習しましょう。
  </div>

  <!-- ===== (1) 基本 1/4 × 1/3 = 1/12 ===== -->
  <div style="font-size:.82em; font-weight:700; color:var(--text-sub); background:var(--primary-light); border-radius:8px; padding:4px 12px; display:inline-block; margin-bottom:8px;">基本パターン</div>
  <div class="problem-card" style="margin-bottom:16px;">
    <div class="problem-head" style="flex-wrap:wrap; gap:14px;">
      <span class="q-num">(1)</span>
      <div class="frac-row" style="flex-wrap:wrap;">
        <span class="frac"><span class="f-num">1</span><span class="f-bar"></span><span class="f-den">4</span></span>
        <span class="eq-sign">×</span>
        <span class="frac"><span class="f-num">1</span><span class="f-bar"></span><span class="f-den">3</span></span>
        <span class="eq-sign">＝</span>
        <span class="frac-dual">
          <input type="number" id="ex1_n" class="f-input" inputmode="numeric" placeholder="?">
          <span class="f-bar"></span>
          <input type="number" id="ex1_d" class="f-input" inputmode="numeric" placeholder="?">
        </span>
        <button onclick="checkEx(1,1,12)" class="btn-submit" style="padding:10px 24px; font-size:.9em;">判定</button>
        <span id="res1" style="font-size:1.5em; font-weight:700;"></span>
      </div>
    </div>
    <div class="answer-box" style="margin:0 20px 16px;">
      <details>
        <summary class="answer-summary">💡 解き方を見る<span class="toggle-icon">›</span></summary>
        <div class="answer-body">
          <p>分子どうし、分母どうしをそれぞれかけます。</p>
          <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap; margin:8px 0;">
            <span class="frac-sm">
              <span class="f-num" style="color:var(--text-sub); font-size:.9em;">1 × 1</span>
              <span class="f-bar"></span>
              <span class="f-den" style="color:var(--text-sub); font-size:.9em;">4 × 3</span>
            </span>
            <span>＝</span>
            <span class="frac-sm">
              <span class="f-num" style="color:var(--accent); font-weight:700;">1</span>
              <span class="f-bar" style="background:var(--accent);"></span>
              <span class="f-den" style="font-weight:700;">12</span>
            </span>
          </div>
          <div class="answer-final">答え：分子 <strong>1</strong>　分母 <strong>12</strong></div>
        </div>
      </details>
    </div>
  </div>

  <!-- ===== (2) ななめ約分 2/5 × 3/8 = 3/20 ===== -->
  <div style="font-size:.82em; font-weight:700; color:var(--warn); background:var(--warn-light); border-radius:8px; padding:4px 12px; display:inline-block; margin-bottom:8px;">ななめ約分パターン</div>
  <div class="problem-card" style="margin-bottom:16px;">
    <div class="problem-head" style="flex-wrap:wrap; gap:14px;">
      <span class="q-num">(2)</span>
      <div class="frac-row" style="flex-wrap:wrap;">
        <span class="frac"><span class="f-num">2</span><span class="f-bar"></span><span class="f-den">5</span></span>
        <span class="eq-sign">×</span>
        <span class="frac"><span class="f-num">3</span><span class="f-bar"></span><span class="f-den">8</span></span>
        <span class="eq-sign">＝</span>
        <span class="frac-dual">
          <input type="number" id="ex2_n" class="f-input" inputmode="numeric" placeholder="?">
          <span class="f-bar"></span>
          <input type="number" id="ex2_d" class="f-input" inputmode="numeric" placeholder="?">
        </span>
        <button onclick="checkEx(2,3,20)" class="btn-submit" style="padding:10px 24px; font-size:.9em;">判定</button>
        <span id="res2" style="font-size:1.5em; font-weight:700;"></span>
      </div>
    </div>
    <div class="answer-box" style="margin:0 20px 16px;">
      <details>
        <summary class="answer-summary">💡 解き方を見る<span class="toggle-icon">›</span></summary>
        <div class="answer-body">
          <p>かける前に<strong style="color:var(--accent);">ななめ約分</strong>を探します。</p>
          <div style="background:var(--warn-light); border-radius:8px; padding:10px 12px; margin-bottom:10px;">
            <p style="margin:0 0 6px; font-size:.9em;"><strong style="color:var(--accent);">2</strong>（左の分子）と <strong style="color:var(--accent);">8</strong>（右の分母）は どちらも <strong>2</strong> で割れる！</p>
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
              <span class="frac-sm"><span class="f-num" style="color:var(--accent);">2</span><span class="f-bar"></span><span class="f-den">5</span></span>
              <span>×</span>
              <span class="frac-sm"><span class="f-num">3</span><span class="f-bar"></span><span class="f-den" style="color:var(--accent);">8</span></span>
              <span style="font-size:.85em; color:var(--text-sub);">÷2でそれぞれ →</span>
              <span class="frac-sm"><span class="f-num" style="color:var(--primary);">1</span><span class="f-bar"></span><span class="f-den">5</span></span>
              <span>×</span>
              <span class="frac-sm"><span class="f-num">3</span><span class="f-bar"></span><span class="f-den" style="color:var(--primary);">4</span></span>
            </div>
          </div>
          <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap; margin:8px 0;">
            <span class="frac-sm">
              <span class="f-num" style="color:var(--text-sub); font-size:.9em;">1 × 3</span>
              <span class="f-bar"></span>
              <span class="f-den" style="color:var(--text-sub); font-size:.9em;">5 × 4</span>
            </span>
            <span>＝</span>
            <span class="frac-sm">
              <span class="f-num" style="color:var(--accent); font-weight:700;">3</span>
              <span class="f-bar" style="background:var(--accent);"></span>
              <span class="f-den" style="font-weight:700;">20</span>
            </span>
          </div>
          <div class="answer-final">答え：分子 <strong>3</strong>　分母 <strong>20</strong></div>
        </div>
      </details>
    </div>
  </div>

  <!-- ===== (3) 帯分数 1と2/3 × 9/10 = 3/2 ===== -->
  <div style="font-size:.82em; font-weight:700; color:var(--primary); background:var(--primary-light); border-radius:8px; padding:4px 12px; display:inline-block; margin-bottom:8px;">帯分数パターン</div>
  <div class="problem-card" style="margin-bottom:16px;">
    <div class="problem-head" style="flex-wrap:wrap; gap:14px;">
      <span class="q-num">(3)</span>
      <div class="frac-row" style="flex-wrap:wrap;">
        <div style="display:flex; align-items:center; gap:4px;">
          <span style="font-size:clamp(1.3em,3vw,1.8em); font-weight:700; color:var(--warn);">1</span>
          <span class="frac"><span class="f-num">2</span><span class="f-bar"></span><span class="f-den">3</span></span>
        </div>
        <span class="eq-sign">×</span>
        <span class="frac"><span class="f-num">9</span><span class="f-bar"></span><span class="f-den">10</span></span>
        <span class="eq-sign">＝</span>
        <span class="frac-dual">
          <input type="number" id="ex3_n" class="f-input" inputmode="numeric" placeholder="?">
          <span class="f-bar"></span>
          <input type="number" id="ex3_d" class="f-input" inputmode="numeric" placeholder="?">
        </span>
        <button onclick="checkEx(3,3,2)" class="btn-submit" style="padding:10px 24px; font-size:.9em;">判定</button>
        <span id="res3" style="font-size:1.5em; font-weight:700;"></span>
      </div>
    </div>
    <div class="answer-box" style="margin:0 20px 16px;">
      <details>
        ...
        <div class="answer-body">
          <div style="background:var(--warn-light); border-radius:8px; padding:10px 12px; margin-bottom:10px;">
            <div style="font-size:.82em; font-weight:700; color:var(--warn); margin-bottom:6px;">① 帯分数を仮分数になおす</div>
            <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
              <div style="display:flex; align-items:center; gap:4px;">
                <span style="font-weight:700; color:var(--warn);">1</span>
                <span class="frac-sm"><span class="f-num">2</span><span class="f-bar"></span><span class="f-den">3</span></span>
              </div>
              <span>→</span>
              <span style="font-size:.88em; color:var(--text-sub);">(1×3)＋2 ＝ 5</span>
              <span>→</span>
              <span class="frac-sm">
                <span class="f-num" style="color:var(--accent); font-weight:700;">5</span>
                <span class="f-bar" style="background:var(--accent);"></span>
                <span class="f-den" style="color:var(--primary); font-weight:700;">3</span>
              </span>
            </div>
          </div>
          <div style="background:var(--primary-light); border-radius:8px; padding:10px 12px; margin-bottom:10px;">
            <div style="font-size:.82em; font-weight:700; color:var(--primary); margin-bottom:6px;">② ななめ約分してかける</div>
            <p style="font-size:.88em; margin:0 0 6px;">5と10は÷5、3と9は÷3でそれぞれ約分できる！</p>
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
              <span class="frac-sm"><span class="f-num" style="color:var(--accent);">5</span><span class="f-bar"></span><span class="f-den" style="color:var(--primary);">3</span></span>
              <span>×</span>
              <span class="frac-sm"><span class="f-num" style="color:var(--primary);">9</span><span class="f-bar"></span><span class="f-den" style="color:var(--accent);">10</span></span>
              <span style="font-size:.82em; color:var(--text-sub);">→ ÷5, ÷3 →</span>
              <span class="frac-sm"><span class="f-num" style="color:var(--accent);">1</span><span class="f-bar"></span><span class="f-den" style="color:var(--primary);">1</span></span>
              <span>×</span>
              <span class="frac-sm"><span class="f-num" style="color:var(--primary);">3</span><span class="f-bar"></span><span class="f-den" style="color:var(--accent);">2</span></span>
              <span>＝</span>
              <span class="frac-sm">
                <span class="f-num" style="color:var(--accent); font-weight:700;">3</span>
                <span class="f-bar" style="background:var(--accent);"></span>
                <span class="f-den" style="font-weight:700;">2</span>
              </span>
            </div>
          </div>
          <div class="answer-final">答え：分子 <strong>3</strong>　分母 <strong>2</strong></div>
        </div>
      </details>
    </div>
  </div>
  ...
  <!-- ===== (4) 基本 3/5 × 2/7 = 6/35 ===== -->
  <div style="font-size:.82em; font-weight:700; color:var(--text-sub); background:var(--primary-light); border-radius:8px; padding:4px 12px; display:inline-block; margin-bottom:8px;">基本パターン（確認）</div>
  <div class="problem-card" style="margin-bottom:28px;">
    <div class="problem-head" style="flex-wrap:wrap; gap:14px;">
      <span class="q-num">(4)</span>
      <div class="frac-row" style="flex-wrap:wrap;">
        <span class="frac"><span class="f-num">3</span><span class="f-bar"></span><span class="f-den">5</span></span>
        <span class="eq-sign">×</span>
        <span class="frac"><span class="f-num">2</span><span class="f-bar"></span><span class="f-den">7</span></span>
        <span class="eq-sign">＝</span>
        <span class="frac-dual">
          <input type="number" id="ex4_n" class="f-input" inputmode="numeric" placeholder="?">
          <span class="f-bar"></span>
          <input type="number" id="ex4_d" class="f-input" inputmode="numeric" placeholder="?">
        </span>
        <button onclick="checkEx(4,6,35)" class="btn-submit" style="padding:10px 24px; font-size:.9em;">判定</button>
        <span id="res4" style="font-size:1.5em; font-weight:700;"></span>
      </div>
    </div>
    <div class="answer-box" style="margin:0 20px 16px;">
      <details>
        <summary class="answer-summary">💡 解き方を見る<span class="toggle-icon">›</span></summary>
        <div class="answer-body">
          <p>約分できるか確認→ 3・5・2・7 はどれも共通の約数なし。そのままかけます。</p>
          <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap; margin:8px 0;">
            <span class="frac-sm">
              <span class="f-num" style="color:var(--text-sub); font-size:.9em;">3 × 2</span>
              <span class="f-bar"></span>
              <span class="f-den" style="color:var(--text-sub); font-size:.9em;">5 × 7</span>
            </span>
            <span>＝</span>
            <span class="frac-sm">
              <span class="f-num" style="color:var(--accent); font-weight:700;">6</span>
              <span class="f-bar" style="background:var(--accent);"></span>
              <span class="f-den" style="font-weight:700;">35</span>
            </span>
          </div>
          <div class="answer-final">答え：分子 <strong>6</strong>　分母 <strong>35</strong></div>
        </div>
      </details>
    </div>
  </div>
  ...
  <div class="memo-box">
    📌 <strong>手順：</strong>①帯分数→仮分数　②ななめ約分できないか確認　③分子・分母どうしかける
  </div>
...
<script>
function checkEx(num, ansN, ansD) {
  const inN = document.getElementById('ex'+num+'_n');
  const inD = document.getElementById('ex'+num+'_d');
  const res = document.getElementById('res'+num);
  inN.classList.remove('correct','wrong');
  inD.classList.remove('correct','wrong');
  if (parseInt(inN.value)===ansN && parseInt(inD.value)===ansD) {

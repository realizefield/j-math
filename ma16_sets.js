...
<style>
  ...
  .dec-input::-webkit-outer-spin-button { -webkit-appearance: none; }
  ...
  .step-block { border-radius:10px; padding:12px 16px; margin-bottom:10px; }
  .step-block.y { background:var(--warn-light);    border:1.5px solid var(--warn); }
  .step-block.b { background:var(--primary-light); border:1.5px solid var(--primary); }
  .step-block.g { background:var(--success-light); border:1.5px solid var(--success); }
  .step-lbl { font-size:.78em; font-weight:700; margin-bottom:6px; }
  .step-block.y .step-lbl { color:var(--warn); }
  .step-block.b .step-lbl { color:var(--primary); }
  .step-block.g .step-lbl { color:var(--success); }
...
<main class="g-container">
  ...
  <div class="instruction">
    <strong>【例題】</strong>　3ステップで小数のかけ算を練習しましょう。答えを入力して「判定」してみよう！
  </div>

  <!-- ===== (1) 0.3 × 4 = 1.2 ===== -->
  <div style="font-size:.82em; font-weight:700; color:var(--primary); background:var(--primary-light); border-radius:8px; padding:4px 12px; display:inline-block; margin-bottom:8px;">小数 × 整数</div>
  <div class="problem-card" style="margin-bottom:16px;">
    <div class="problem-head" style="flex-wrap:wrap; gap:14px;">
      <span class="q-num">(1)</span>
      <div style="display:flex; align-items:center; gap:clamp(8px,2vw,16px); flex-wrap:wrap;">
        <span class="big" style="color:var(--primary);">0.3</span>
        <span class="big" style="color:var(--text-sub);">×</span>
        <span class="big">4</span>
        <span class="big" style="color:var(--text-sub);">=</span>
        <input type="text" id="ex1" class="dec-input" placeholder="?">
        <button onclick="checkEx(1,'1.2')" class="btn-submit" style="padding:10px 24px; font-size:.9em;">判定</button>
    ...
    <div class="answer-box" style="margin:0 20px 16px;">
      <details>
        ...
        <div class="answer-body">
          <div class="step-block y">
            <div class="step-lbl">① 小数点を取り除いて整数にする</div>
            <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
              <span style="color:var(--primary); font-weight:700;">0.3 → <span style="font-size:1.3em;">3</span></span>
              <span style="font-size:.85em; color:var(--text-sub);">（小数点を右に1つ移動）</span>
            </div>
          </div>
          <div class="step-block b">
            <div class="step-lbl">② 整数どうしのかけ算</div>
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
              <span style="font-size:1.3em; font-weight:700; color:var(--primary);">3</span>
              <span style="font-weight:700; color:var(--text-sub);">×</span>
              <span style="font-size:1.3em; font-weight:700;">4</span>
              <span style="font-weight:700; color:var(--text-sub);">＝</span>
              <span style="font-size:1.4em; font-weight:700; color:var(--accent);">12</span>
            </div>
          </div>
          <div class="step-block g">
            <div class="step-lbl">③ 小数点を左に <strong>1つ</strong> 移動（1桁ずらした分）</div>
            <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
              <span style="font-size:1.4em; font-weight:700; color:var(--accent);">12</span>
              <span style="color:var(--text-sub);">→</span>
              <span style="font-size:1.6em; font-weight:700; color:var(--success);">1.2</span>
            </div>
          </div>
          <div class="answer-final">答え：<strong>1.2</strong></div>
        </div>
      </details>
    </div>
  </div>
  ...
  <!-- ===== (2) 1.2 × 3 = 3.6 ===== -->
  <div style="font-size:.82em; font-weight:700; color:var(--primary); background:var(--primary-light); border-radius:8px; padding:4px 12px; display:inline-block; margin-bottom:8px;">小数 × 整数（1より大きい小数）</div>
  <div class="problem-card" style="margin-bottom:16px;">
    <div class="problem-head" style="flex-wrap:wrap; gap:14px;">
      <span class="q-num">(2)</span>
      <div style="display:flex; align-items:center; gap:clamp(8px,2vw,16px); flex-wrap:wrap;">
        <span class="big" style="color:var(--primary);">1.2</span>
        <span class="big" style="color:var(--text-sub);">×</span>
        <span class="big">3</span>
        <span class="big" style="color:var(--text-sub);">=</span>
        <input type="text" id="ex2" class="dec-input" placeholder="?">
        <button onclick="checkEx(2,'3.6')" class="btn-submit" style="padding:10px 24px; font-size:.9em;">判定</button>
    ...
    <div class="answer-box" style="margin:0 20px 16px;">
      <details>
        ...
        <div class="answer-body">
          <div class="step-block y">
            <div class="step-lbl">① 小数点を取り除いて整数にする</div>
            <span style="color:var(--primary); font-weight:700;">1.2 → <span style="font-size:1.3em;">12</span></span>
            <span style="font-size:.85em; color:var(--text-sub); margin-left:8px;">（1桁ずらし）</span>
          </div>
          <div class="step-block b">
            <div class="step-lbl">② 整数どうしのかけ算</div>
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
              <span style="font-size:1.3em; font-weight:700; color:var(--primary);">12</span>
              <span style="font-weight:700; color:var(--text-sub);">×</span>
              <span style="font-size:1.3em; font-weight:700;">3</span>
              <span style="font-weight:700; color:var(--text-sub);">＝</span>
              <span style="font-size:1.4em; font-weight:700; color:var(--accent);">36</span>
            </div>
          </div>
          <div class="step-block g">
            <div class="step-lbl">③ 小数点を左に <strong>1つ</strong> 移動</div>
            <span style="font-size:1.4em; font-weight:700; color:var(--accent);">36</span>
            <span style="color:var(--text-sub); margin:0 6px;">→</span>
            <span style="font-size:1.6em; font-weight:700; color:var(--success);">3.6</span>
          </div>
          <div class="answer-final">答え：<strong>3.6</strong></div>
        </div>
      </details>
    </div>
  </div>
  ...
  <!-- ===== (3) 0.4 × 0.3 = 0.12 ===== -->
  <div style="font-size:.82em; font-weight:700; color:var(--warn); background:var(--warn-light); border-radius:8px; padding:4px 12px; display:inline-block; margin-bottom:8px;">小数 × 小数（桁に注意！）</div>
  <div class="problem-card" style="margin-bottom:16px;">
    <div class="problem-head" style="flex-wrap:wrap; gap:14px;">
      <span class="q-num">(3)</span>
      <div style="display:flex; align-items:center; gap:clamp(8px,2vw,16px); flex-wrap:wrap;">
        <span class="big" style="color:var(--primary);">0.4</span>
        <span class="big" style="color:var(--text-sub);">×</span>
        <span class="big" style="color:var(--warn);">0.3</span>
        <span class="big" style="color:var(--text-sub);">=</span>
        <input type="text" id="ex3" class="dec-input" placeholder="?">
        <button onclick="checkEx(3,'0.12')" class="btn-submit" style="padding:10px 24px; font-size:.9em;">判定</button>
    ...
    <div class="answer-box" style="margin:0 20px 16px;">
      <details>
        ...
        <div class="answer-body">
          <div class="step-block y">
            <div class="step-lbl">① 小数点を取り除いて整数にする（両方！）</div>
            <div style="display:flex; gap:16px; flex-wrap:wrap;">
              <span style="color:var(--primary); font-weight:700;">0.4 → <span style="font-size:1.2em;">4</span> <span style="font-size:.8em;">(1桁)</span></span>
              <span style="color:var(--warn); font-weight:700;">0.3 → <span style="font-size:1.2em;">3</span> <span style="font-size:.8em;">(1桁)</span></span>
            </div>
          </div>
          <div class="step-block b">
            <div class="step-lbl">② 整数どうしのかけ算</div>
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
              <span style="font-size:1.3em; font-weight:700; color:var(--primary);">4</span>
              <span style="font-weight:700; color:var(--text-sub);">×</span>
              <span style="font-size:1.3em; font-weight:700; color:var(--warn);">3</span>
              <span style="font-weight:700; color:var(--text-sub);">＝</span>
              <span style="font-size:1.4em; font-weight:700; color:var(--accent);">12</span>
            </div>
          </div>
          <div class="step-block g">
            <div class="step-lbl">③ 小数点を左に <strong>2つ</strong> 移動（1＋1＝2桁）</div>
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
              <span style="font-size:1.4em; font-weight:700; color:var(--accent);">12</span>
              <span style="color:var(--text-sub);">→</span>
              <span style="font-size:.95em; color:var(--text-sub);">「12.」→ 左に2つ →</span>
              <span style="font-size:1.6em; font-weight:700; color:var(--success);">0.12</span>
            </div>
            <p style="font-size:.84em; color:var(--text-sub); margin:6px 0 0;">
              ⚠️ 左に2つ移動すると整数部分がなくなる → <strong>0.12</strong> と書く（「.12」ではなく必ず0をつける）
            </p>
          </div>
          <div class="answer-final">答え：<strong>0.12</strong></div>
        </div>
      </details>
    </div>
  </div>
  ...
  <!-- ===== (4) 2.5 × 1.2 = 3 ===== -->
  <div style="font-size:.82em; font-weight:700; color:var(--accent); background:var(--accent-light); border-radius:8px; padding:4px 12px; display:inline-block; margin-bottom:8px;">末尾の0を消すパターン</div>
  <div class="problem-card" style="margin-bottom:28px;">
    <div class="problem-head" style="flex-wrap:wrap; gap:14px;">
      <span class="q-num">(4)</span>
      <div style="display:flex; align-items:center; gap:clamp(8px,2vw,16px); flex-wrap:wrap;">
        <span class="big" style="color:var(--primary);">2.5</span>
        <span class="big" style="color:var(--text-sub);">×</span>
        <span class="big" style="color:var(--warn);">1.2</span>
        <span class="big" style="color:var(--text-sub);">=</span>
        <input type="text" id="ex4" class="dec-input" placeholder="?">
        <button onclick="checkEx(4,'3')" class="btn-submit" style="padding:10px 24px; font-size:.9em;">判定</button>
    ...
    <div class="answer-box" style="margin:0 20px 16px;">
      <details>
        ...
        <div class="answer-body">
          <div class="step-block y">
            <div class="step-lbl">① 整数にする</div>
            <div style="display:flex; gap:16px; flex-wrap:wrap;">
              <span style="color:var(--primary); font-weight:700;">2.5 → <span style="font-size:1.2em;">25</span> <span style="font-size:.8em;">(1桁)</span></span>
              <span style="color:var(--warn); font-weight:700;">1.2 → <span style="font-size:1.2em;">12</span> <span style="font-size:.8em;">(1桁)</span></span>
            </div>
          </div>
          <div class="step-block b">
            <div class="step-lbl">② かけ算</div>
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
              <span style="font-size:1.3em; font-weight:700; color:var(--primary);">25</span>
              <span style="font-weight:700; color:var(--text-sub);">×</span>
              <span style="font-size:1.3em; font-weight:700; color:var(--warn);">12</span>
              <span style="font-weight:700; color:var(--text-sub);">＝</span>
              <span style="font-size:1.4em; font-weight:700; color:var(--accent);">300</span>
            </div>
          </div>
          <div class="step-block g">
            <div class="step-lbl">③ 小数点を左に <strong>2つ</strong> 移動</div>
            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
              <span style="font-size:1.4em; font-weight:700; color:var(--accent);">300</span>
              <span style="color:var(--text-sub);">→</span>
              <span style="font-size:1.3em; font-weight:700; color:var(--text-sub); text-decoration:line-through;">3.00</span>
              <span style="color:var(--text-sub);">→ 末尾の0を消す →</span>
              <span style="font-size:1.6em; font-weight:700; color:var(--success);">3</span>
            </div>
          </div>
          <div class="answer-final">答え：<strong>3</strong>（3.00ではなく3と書く）</div>
        </div>
      </details>
    </div>
  </div>
...
<script>
function checkEx(num, ans) {
  const inp = document.getElementById('ex'+num);
  const res = document.getElementById('res'+num);
  inp.classList.remove('correct','wrong');
  // 末尾0除去して比較（例:3.0も3として正解扱い）
  const val = parseFloat(inp.value);
  const correct = parseFloat(ans);
  if (!isNaN(val) && Math.abs(val - correct) < 0.0001) {

...
<main class="g-container">
  ...
  <div class="section-title">「1」の正体を見破ろう！</div>

  <div class="lead-text">
    「1 －
    <span class="frac" style="font-size:1.2em; vertical-align:middle;">
      <span class="f-num">2</span><span class="f-bar"></span><span class="f-den">3</span>
    </span>
    」のような計算のポイントは、<strong>「1」を相手の分母に合わせた分数に変身させる</strong>ことです！
  </div>

  <!-- 1の変身ルール -->
  <div class="summary-box" style="border-color:#fb7185; background:#fff1f2;">
    <div class="summary-title" style="color:#e11d48;">✨ 1の変身ルール</div>
    <div style="display:flex; align-items:center; justify-content:center; gap:clamp(10px,2vw,20px); flex-wrap:wrap; font-size:clamp(1.1em,3vw,1.5em); margin:10px 0;">
      <strong>1</strong>
      <span class="eq-sign">＝</span>
      <span class="frac">
        <span class="f-num">2</span><span class="f-bar"></span><span class="f-den">2</span>
      </span>
      <span class="eq-sign">＝</span>
      <span class="frac">
        <span class="f-num">3</span><span class="f-bar"></span><span class="f-den">3</span>
      </span>
      <span class="eq-sign">＝</span>
      <span class="frac">
        <span class="f-num">4</span><span class="f-bar"></span><span class="f-den">4</span>
      </span>
      <span class="eq-sign">＝</span>
      <span style="font-size:.85em; color:var(--text-sub);">…</span>
    </div>
    <p style="text-align:center; font-size:.95em; color:var(--text-sub); margin:0;">
      分母と分子が同じなら、いつでも「1」になります。
    </p>
  </div>

  <!-- たし算の例 -->
  <div class="section-title">たし算の例</div>
  <div class="problem-card" style="padding:24px 20px; margin-bottom:16px;">
    <div style="display:flex; align-items:center; justify-content:center; gap:clamp(8px,2vw,16px); flex-wrap:wrap; font-size:clamp(1em,2.5vw,1.3em);">
      <strong style="font-size:1.3em;">1</strong>
      <span class="eq-sign">＋</span>
      <span class="frac"><span class="f-num">5</span><span class="f-bar"></span><span class="f-den">6</span></span>
      <span class="eq-sign">＝</span>
      <span class="frac" style="color:var(--primary);">
        <span class="f-num">6</span><span class="f-bar"></span><span class="f-den">6</span>
      </span>
      <span class="eq-sign">＋</span>
      <span class="frac"><span class="f-num">5</span><span class="f-bar"></span><span class="f-den">6</span></span>
      <span class="eq-sign">＝</span>
      <span class="frac" style="color:var(--accent);">
        <span class="f-num">11</span><span class="f-bar"></span><span class="f-den">6</span>
      </span>
    </div>
    <div class="memo-box" style="margin-top:14px; margin-bottom:0;">
      ✅ 1 を
      <span class="frac-sm" style="vertical-align:middle; margin:0 4px;">
        <span class="f-num" style="color:var(--primary);">6</span><span class="f-bar"></span><span class="f-den" style="color:var(--primary);">6</span>
      </span>
      に変身させて、分子どうしをたします！
    </div>
  </div>
  ...
  <!-- ひき算の例 -->
  <div class="section-title">ひき算の例</div>
  <div class="problem-card" style="padding:24px 20px; margin-bottom:20px;">
    <div style="display:flex; align-items:center; justify-content:center; gap:clamp(8px,2vw,16px); flex-wrap:wrap; font-size:clamp(1em,2.5vw,1.3em);">
      <strong style="font-size:1.3em;">1</strong>
      <span class="eq-sign">－</span>
      <span class="frac"><span class="f-num">3</span><span class="f-bar"></span><span class="f-den">7</span></span>
      <span class="eq-sign">＝</span>
      <span class="frac" style="color:var(--primary);">
        <span class="f-num">7</span><span class="f-bar"></span><span class="f-den">7</span>
      </span>
      <span class="eq-sign">－</span>
      <span class="frac"><span class="f-num">3</span><span class="f-bar"></span><span class="f-den">7</span></span>
      <span class="eq-sign">＝</span>
    ...
    <div class="memo-box" style="margin-top:14px; margin-bottom:0;">
      ✅ 1 を
      <span class="frac-sm" style="vertical-align:middle; margin:0 4px;">
        <span class="f-num" style="color:var(--primary);">7</span><span class="f-bar"></span><span class="f-den" style="color:var(--primary);">7</span>
      </span>
      に変身させて、分子どうしをひきます！
    </div>
  </div>
  ...
  <div class="summary-box">
    ...
    <ul>
      <li>「1 ＋ 分数」「1 － 分数」は、まず <strong>1 を分数に変身</strong>させる。</li>
      <li>変身のルール：相手の分母に合わせて
        <span class="frac-sm" style="vertical-align:middle; margin:0 4px;">
          <span class="f-num">分母</span><span class="f-bar"></span><span class="f-den">分母</span>
        </span>
        にする。
      </li>
      <li>あとは分子どうしをたす・ひくだけ！</li>
    </ul>
  </div>
